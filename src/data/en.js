export default {
  ...
  tools:
    'Operating system: Linux(over ten years)<br />IDE: PhpStorm / RubyMine<br />Containerization: Docker / Rancher<br />Continuous integration software: Jenkins / Gitlab-CI / Travis<br />Project Management Software: Jira / Gitlab<br />Version control system software: Gitlab / Github<br />',
  educations: [
    {
      schoolName: 'Claude Bernard University Lyon 1',
      fieldOfStudy: 'Metinet (web development)',
      startDate: '2009',
      endDate: '2010',
      degree: 'License',
      activities:
        'Database, PHP, Flash, Java, English, Communication, Javascript',
    },
    {
